...
// 1. Definir o endereço de email de destino no início.
$para = "multiponto.oliveira@multiponto.com"; 

// 2. Verificar se o pedido é POST e se o script não está a ser executado diretamente
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // 5. Preparar os dados para o email
    ...
    //    Definir o remetente com o próprio domínio para evitar spam
    //    Email do utilizador pode ser colocado no Reply-To para poder responder
    ...
    // Se o método não for POST, redirecionar ou exibir mensagem de erro
